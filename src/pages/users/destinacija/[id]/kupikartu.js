...
const Kupikartu = () => {
    ...
    useEffect(() => {
      if (destination) {
        const novaUkupnaCijena = destination.cijena * parseInt(destination.broj_karata);
            ...
            <form >
                <div style={{ margin: '20px', width: '400p', xdisplay: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center" }}>
                    <div style={{ height: '60px', width: '400px', display: "flex", justifyContent: "space-between", alignItems: "space-around" }}>
                        ...
                        <input type="number" id="broj" name="broj" min={1} max={5} required style={{ height: '25px', borderRadius: '10px', padding: '5px' }} {...register('broj_karata')}></input>
                    </div>
                    <div style={{ height: '60px', width: '400p', display: "flex", justifyContent: "space-between", alignItems: "space-around" }}>
                        ...
                        <input type="text" id="kartica" name="kartica" required style={{ height: '25px', borderRadius: '10px', padding: '5px' }} {...register('broj_kartice')}></input>
                    </div>
                    <div style={{ height: '60px', width: '400p', display: "flex", justifyContent: "space-between", alignItems: "space-around" }}>
                        <label for="datum">Datum isteka:</label>
                        <input type="text" id="datum" name="datum" required style={{ height: '25px', borderRadius: '10px', padding: '5px' }} {...register('datum_valjanosti')}></input>
                    </div>
                    <div style={{ height: '60px', width: '400p', display: "flex", justifyContent: "space-between", alignItems: "space-around" }}>
                        <label for="CVC">CVC:</label>
                        <input type="text" id="CVC" name="CVC" required style={{ height: '25px', borderRadius: '10px', padding: '5px' }} {...register('cvc')}></input>
                    </div>
      ...
      {destination && (
        <div className="forma" style={{ margin: '20px', display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center" }}>
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div style={{ margin: '20px', width: '400p', display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center" }}>
              <div style={{ height: '60px', width: '400px', display: "flex", justifyContent: "space-between", alignItems: "space-around" }}>
              ...
              <div style={{ height: '60px', width: '400p', display: "flex", justifyContent: "space-between", alignItems: "space-around" }}>
                ...
                <input type="text" id="kartica" name="kartica" required style={{ height: '25px', borderRadius: '10px', padding: '5px' }} {...register("kartica")} />
              </div>
              <div style={{ height: '60px', width: '400p', display: "flex", justifyContent: "space-between", alignItems: "space-around" }}>
              ...
              <div style={{ height: '60px', width: '400p', display: "flex", justifyContent: "space-between", alignItems: "space-around" }}>
                ...
                <input type="text" id="CVC" name="CVC" required style={{ height: '25px', borderRadius: '10px', padding: '5px' }} {...register("CVC")} />
              </div>
              <div style={{ display: 'flex', justifyContent: 'space-around' }}>
                <p style={{ fontFamily: 'sans-serif' }}>Iskoristi bodove lojalnosti</p>
